...
/**
 * 
 * mybatis_generator的mysql分页插件
 * 
 */
public class GeneratorMysqlLimitOffsetPlugin extends PluginAdapter {
    ...
    public boolean sqlMapSelectByExampleWithoutBLOBsElementGenerated(
        ...
        isNotNullElement.addAttribute(new Attribute("test", "mysqlOffset != null and mysqlOffset>=0")); //$NON-NLS-1$ //$NON-NLS-2$  
        // isNotNullElement.addAttribute(new Attribute("compareValue", "0")); //$NON-NLS-1$ //$NON-NLS-2$  
        isNotNullElement.addElement(new TextElement("limit #{mysqlOffset} , #{mysqlLength}"));
